package Day06andDay07.Arraylist.project;
...
class Orders {
    ...
    public void addItems(MenuItems item) {
        ...
        System.out.println("The item ordered is "
                + item.getName()
                + " | Price: ₹"
                + item.getPrice());
    }
...
public class HungerBox {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nTotal Prepared Orders: "
                + MenuItems.getTotalNumberOfOrders());
    }
}